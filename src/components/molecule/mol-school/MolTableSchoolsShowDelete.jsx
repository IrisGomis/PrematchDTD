...
export default function MolTableSchoolsShowDelete() {
  ...
  function handleDelete() {
    ...
    Promise.all(deletePromises)
      ...
      .catch((error) => {
        console.error(`Error deleting Schoolss: ${error.message}`);
      });
  }
  return (
    <>
    ...
    <div className="bg-stone6 w-full max-w-screen-xl rounded-xl p-20 m-20 text-white">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold leading-7">Lista de escuelas</h1>
        </div>
                    ...
                    <tr key={e.id} className="hover:bg-gray-50">
                      ...
                      <td
                        className={classNames(
                          ...
                          selectedSchools.includes(e.id) ? 'text-indigo-600' : 'text-gray-900'
                        )}
                      >
                        {e.name}
                      </td>
